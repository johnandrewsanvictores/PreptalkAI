      ...
      <div className="">
        <div className="accountInformationContainer px-24">
          <div className="mt-6 profileButtonContainer grid grid-cols-2 w-3/12">
            <button className="h-14 w-full flex flex-row items-center bg-bgColor2 text-subHeadingText rounded-md text-p pl-8">
              ...
              <div className="container1">
                ...
                <div className="jobPositionContainer">
                  ...
                  <input
                    ...
                    name="jobPosition"
                    id="jobPosition"
                    className="jobPosition bg-bgColor2 rounded-md w-full h-14"
                  />
                </div>
              </div>
              ...
              <div className="container2">
                <div className="resumeNameContainer mb-8">
                  ...
                  <input
                    ...
                    name="resumeName"
                    id="resumeName"
                    className="resumeName bg-bgColor2 rounded-md w-full h-14"
                  />
                </div>
