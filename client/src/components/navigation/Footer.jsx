          ...
          <div className="space-y-8">
            ...
            <div>
              <p className="text-subHeadingText dark:text-gray-300 mb-6">
                Empowering you with AI-driven interview preparation to boost
                your confidence and land your dream job.
              </p>
            </div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-subHeadingText dark:text-gray-300 text-sm">
              © 2025 <span className="text-primary">Preptalk</span> AI. All
              rights reserved.
            </p>
