      ...
      <>
        <nav className="bg-bgColor2 py-4 lg:py-6 relative z-50 shadow-sm">
          <div className="flex justify-between items-center w-full mx-auto px-4 lg:px-8">
            <div className="flex items-center">
              <Link to="/" className="flex items-center space-x-3 lg:space-x-4">
                <img src={logo} alt="logo" className="h-10 w-10 lg:h-12 lg:w-12" />
          ...
          {isDropdownOpen && isMobile && (
              <div className="lg:hidden fixed inset-0 bg-black bg-opacity-50 z-50" onClick={() => setIsDropdownOpen(false)}>
                <div className="absolute bottom-0 left-0 right-0 bg-white rounded-t-2xl shadow-xl p-4" onClick={e => e.stopPropagation()}>
